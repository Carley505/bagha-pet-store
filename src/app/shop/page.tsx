...
import { Filter, SlidersHorizontal, Search, Tag, CheckCircle2 } from 'lucide-react';
...
export default async function ShopPage({ searchParams }: ShopPageProps) {
  ...
  const isWholesale = params.wholesale === 'true';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8 font-sans">
      ...
      {/* Header Banner */}
      <div className="bg-sand-gradient p-8 rounded-3xl border border-[#F5F1EA] space-y-3">
      ...
      {/* Mobile Horizontal Category Pills (Quick Tap Carousel) */}
